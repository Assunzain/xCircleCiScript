...
git clone -b GLKernelOC --depth=1 https://github.com/Assunzain/Kernel_asus_X01AD X01AD
git clone -b clang-16 --depth=1 https://gitlab.com/LeCmnGend/proton-clang clang

# Main
KERNEL_NAME=Greenlight.v2.3-OC-[EOL]-STABLE # IMPORTANT ! Declare your kernel name
